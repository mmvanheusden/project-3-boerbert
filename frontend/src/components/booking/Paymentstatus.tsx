...
export function PaymentStatus() {
    ...
    return (<div className="flex flex-col gap-3 h-full">
            ...
            <div className="flex-1 overflow-auto">
                <div
                    className="w-full h-full overflow-auto flex flex-col justify-between items-center bg-white shadow-md rounded-lg py-7">
                ...
                <button
                    className="hover:cursor-pointer py-7 w-full bg-green-600 hover:bg-green-700 rounded-xl text-8xl text-white flex justify-center items-center"
                    onClick={async () => {
