        ...
        <span className="font-bold text-center text-7xl mb-2 italic bg-green-600 text-white rounded-xl p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="inline-flex gap-3">
              <button
                  className="text-5xl hover:cursor-pointer rounded-full ring-green-600 hover:ring-3"
              ...
              <button
                  className="text-5xl hover:cursor-pointer rounded-full p-px ring-green-600 hover:ring-3"
