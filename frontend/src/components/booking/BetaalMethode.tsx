        ...
        <div className="w-full overflow-auto">
                <div className="flex flex-col min-h-screen justify-center items-center bg-white shadow-md rounded-lg p-0 mb-2">
                    ...
                    <div className="inline-flex">
                        <Icon className="mr-5 border-7 rounded-full border-black " icon="streamline-cyber:cash-hand-4" width="148" height="148" />
                        <Icon className="border-7 rounded-full border-black" icon="iconoir:hand-card" width="148" height="148"/>
                    </div>
                </div>
        </div>
