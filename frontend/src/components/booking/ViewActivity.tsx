    ...
    return (
        <div className="flex flex-col gap-3 h-full">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="col-span-2 flex flex-col justify-between">
                            <div className="text-sm text-gray-800">
                                ...
                                <div
                                    className="mb-1">{t("max_participants", {capacity: selectedActivity?.capacity})}</div>

                                <div
                                    className="mb-1">{t("location_label", {location: selectedActivity?.location})}</div>

                                <div className="mb-1">{t("min_age_note", {minage: selectedActivity?.minage})}</div>

                                <div
                                    className="mb-1">{t("price_per_ticket", {price: selectedActivity?.price})}</div>
                            </div>
            ...
            <div className="flex-row flex w-full items-center justify-between">
                ...
                <div>
                    <button
                        className="border-2 hover:underline hover:cursor-pointer rounded py-3 px-5 border-black bg-green-600 hover:bg-green-700 focus:outline-none text-2xl mr-3"
                        onClick={prev}>
                        {t("back_to_list")}
                    </button>
                </div>
